...
public class LobbyRow : EnhancedScrollerCellView
{
    public LobbyCell[] rowCellViews;

    public void SetData(ref SmallList<LobbyData> data, LobbyController marketController, int startingIndex)
    {
