...
namespace Anonym.Isometric
{
    ...
    [System.Serializable]
    [ExecuteInEditMode]
    public class IsoGrid : MonoBehaviour, IGridOperator
    {
        ...
        [SerializeField]
        public IsoGrid parentGrid
        {
            get
            {
                if (_parentGrid == null && transform.parent != null)
                    _parentGrid = transform.parent.GetComponent<IsoGrid>();
