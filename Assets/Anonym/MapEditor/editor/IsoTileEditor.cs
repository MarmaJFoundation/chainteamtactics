    ...
    public class IsoTileEditor : Editor
    {
        ...
        public void OnSceneGUI()
        {
            ...
            if (Event.current.type == UnityEngine.EventType.Layout)
            {
                ...
                GUILayout.Window(windowID, _windowRT, this.ScreenInfoWindow,
            ...
            if (Event.current.type == UnityEngine.EventType.Layout || Event.current.type == UnityEngine.EventType.Repaint
                || Event.current.type == UnityEngine.EventType.MouseDown || Event.current.type == UnityEngine.EventType.MouseMove
                || Event.current.type == UnityEngine.EventType.MouseUp || Event.current.type == UnityEngine.EventType.MouseDrag)
            {
                HandleDraw();
