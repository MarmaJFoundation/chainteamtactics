...
#region MainFeature
        ...
        {
            IsoGrid _grid = tile ? tile.coordinates.grid :null;
            if (_grid == null)
                _grid = grid;
...
#region EditorWindow
        ...
        private void OnEnable()
        {
            ...
            SceneView.duringSceneGui += OnSceneView_HotKey_WithoutFocus;
        }
...
#region UnityEditor
        ...
        bool CheckBrushModeHotKey(Event e)
        {
            ...
            bool bUse = false;
            if (e.type == UnityEngine.EventType.KeyDown && e.functionKey)
            {
                switch(e.keyCode)
                {
                    case KeyCode.F12:
