    ...
    public partial class CustomEditorGUI
    {
        ...
        public class SimpleGrid<T> where T : Object
        {
            ...
            static bool DrawCell(System.Action<T, Rect> drawCell, T element, List<T> selection, float fWidth, bool bObjectField, bool bMultiSelectable, Color selectedColor, bool bDragable)
            {
                ...
                if (evt.type == UnityEngine.EventType.ScrollWheel)
                {
                    return bResult;
                }
                ...
                if (evt.type == UnityEngine.EventType.Repaint || evt.type == UnityEngine.EventType.Layout)
                {
                    if (bSelected)
                ...
                else if (bSelectable && evt.type == UnityEngine.EventType.MouseUp && evt.button == 0)
                {
                    ...
                    && (evt.type == UnityEngine.EventType.MouseDown || evt.type == UnityEngine.EventType.MouseUp || evt.type == UnityEngine.EventType.MouseDrag)
